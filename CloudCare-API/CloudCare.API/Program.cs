...
// docker build -t hashirowais/cloudcare-api:tag .  
// docker run -d --name cloudcare-api -p 5001:5000 -e CONNECTION_STRING="Server=192.168.69.200;Port=5432;Database=Cloudcare_UAT;Username=CloudCare;Password=dw;" \ hashirowais/cloudcare-api:tag